...
export const QUESTS: QuestDef[] = [
  {
    ...
    description: 'Follow the main $TACHI Farcaster account',
    platform: 'farcaster',
    action: 'follow_user',
    ...
    repeatable: false,
    enabled: true,
    target: { targetFid: Number(process.env.FC_TARGET_FID || 0) },
  },
  {
    id: 'fc-recast-launch',
    title: 'Recast launch cast',
    description: 'Recast the official $TACHI launch cast',
    platform: 'farcaster',
    action: 'recast_cast',
  ...
  },
  {
    id: 'x-follow',
    title: 'Follow on X',
    description: 'Open the X profile',
    platform: 'x',
    ...
    repeatable: false,
    enabled: true,
    target: { url: 'https://x.com/YOUR_HANDLE' },
  },
];
